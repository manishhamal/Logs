...
export const BLOG_NAME = "Manish Hamal";
...
/* 
  ...
  Copy the object below and paste it into the ARTICLES array.

  {
    id: "unique-slug-id",
    title: "Your Title Here",
    excerpt: "A brief summary for the preview card.",
    date: "2024-05-20", 
    category: Category.Technology, // or History, Politics
    readTime: "5 min read",
    tags: ["Tag1", "Tag2"],
    featuredImage: "https://link-to-your-image.com/image.jpg", // Optional
    content: `
...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    content: `<p>When the steam engine arrived, it replaced muscle. It allowed us to move faster and build bigger. The current revolution is different. It replaces the cognitive drudgery.</p>`
  }
];